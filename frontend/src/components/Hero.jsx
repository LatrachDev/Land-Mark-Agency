      ...
      <div className="max-w-full">
       ...
       <div className="flex flex-col text-white justify-start items-start">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 lg:gap-8">
          <Link to="/contact" className="bg-[#445EF2] text-white px-3 py-2 sm:px-4 sm:py-2 md:px-10 lg:py-3 transition-all duration-300 hover:bg-white hover:text-black hover:scale-105 text-sm text-center whitespace-nowrap">
            DEMANDEZ VOTRE DEVIS
          </Link>
          <Link to="/portfolio" className="border border-white text-white px-3 py-2 sm:px-4 sm:py-2 md:px-10 lg:py-3 transition-all duration-300 hover:bg-white hover:text-black hover:scale-105 text-sm text-center whitespace-nowrap">
            VOIR LES PROJETS
          </Link>
        </div>
